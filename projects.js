/* =====================================================================
   ...
   Order: newest first — except LA GRASSE MATINÉE, always first in open.
   ===================================================================== */
...
window.GC_PROJECTS = {
  open: [
  {
    ...
    videos:   ['uploads/pd/grasse-1.mp4'],
    locked:   false,
  ...
  },
  {
    ...
    videos:   ['uploads/pd/ultrarem-1.mp4'],
    locked:   false,
  ...
  {
    id:       'pd-peron',
    title:    'FRANÇOIS PÉRON',
    cover:    'uploads/pd/peron-cover.gif',
    videos:   ['uploads/pd/peron-1.mp4'],
    locked:   false,
    desc:     'A motion piece for the Muséum d\'Histoire Naturelle du Havre, retracing the voyages of naturalist François Péron through animated maps and specimens.',
    meta:     '2021 · Personal · Concept, Design, Animation · AE · C4D',
  },
  ],
  client: [
  {
    ...
    videos:   ['uploads/gd/biscuit-2.mp4', 'uploads/gd/biscuit-1.mp4'],
    locked:   true,
  ...
  },
  {
    ...
    videos:   ['uploads/gd/election-3.mp4', 'uploads/gd/election-2.mp4', 'uploads/gd/election-4.mp4'],
    locked:   true,
  ...
  },
  {
    ...
    videos:   ['uploads/gd/jinglet18-1.mp4', 'uploads/gd/jinglet18-2.mp4', 'uploads/gd/jinglet18-3.mp4', 'uploads/gd/jinglet18-4.mp4'],
    locked:   true,
  ...
  },
  {
    ...
    videos:   ['uploads/gd/newsletter-1.mp4', 'uploads/gd/newsletter-2.mp4'],
    locked:   true,
  ...
  },
  {
    ...
    videos:   ['uploads/gd/tf1-1.mp4', 'uploads/gd/tf1-2.mp4', 'uploads/gd/tf1-3.mp4', 'uploads/gd/tf1-4.mp4'],
    locked:   true,
  ...
  },
  {
    ...
    videos:   ['uploads/gd/identf4-1.mp4', 'uploads/gd/identf4-2.mp4', 'uploads/gd/identf4-3.mp4', 'uploads/gd/identf4-4.mp4', 'uploads/gd/identf4-5.mp4'],
    locked:   true,
  ...
  },
  {
    ...
    videos:   ['uploads/gd/antena3-1.mp4', 'uploads/gd/antena3-2.mp4'],
    locked:   true,
  ...
  },
  {
    ...
    videos:   ['uploads/gd/gent18-1.mp4', 'uploads/gd/gent18-2.mp4', 'uploads/gd/gent18-3.mp4', 'uploads/gd/gent18-4.mp4', 'uploads/gd/gent18-5.mp4'],
    locked:   true,
  ...
  },
  {
    ...
    videos:   ['uploads/gd/tv5j-1.mp4', 'uploads/gd/tv5j-2.mp4', 'uploads/gd/tv5j-3.mp4', 'uploads/gd/tv5j-4.mp4'],
    locked:   true,
  ...
  },
  {
    id:       'gd-ocs',
    title:    'OCS — IDENTS',
    cover:    'uploads/gd/ocs-cover.gif',
    videos:   ['uploads/gd/ocs-1.mp4', 'uploads/gd/ocs-2.mp4', 'uploads/gd/ocs-3.mp4'],
    locked:   true,
    desc:     'Ident concepts for the OCS cinema channels.',
    meta:     '2025 · Design, Animation · AE',
  },
  {
    id:       'gd-rtl',
  ...
  {
    id:       'gd-p24',
    title:    'PARIS 2024 — BEST-OF FILMS',
    cover:    'uploads/gd/p24-cover.gif',
    videos:   ['uploads/gd/p24-1.mp4', 'uploads/gd/p24-2.mp4', 'uploads/gd/p24-3.mp4', 'uploads/gd/p24-4.mp4', 'uploads/gd/p24-5.mp4', 'uploads/gd/p24-6.mp4'],
    locked:   true,
    desc:     'Best-of films for the Paris 2024 Olympic Games — six episodes on the look, the mascot, the French team and the ceremonies.',
    meta:     '2024 · Design, Animation · AE',
  },
  {
    id:       'gd-m6',
    title:    'M6 CINÉMA',
    cover:    'uploads/gd/m6-cover.gif',
    videos:   ['uploads/gd/m6-1.mp4'],
    locked:   true,
    desc:     'A title design for M6 Cinéma — a cinematic opener where light and type set the mood before a film even starts.',
    meta:     '2022 · Concept, Design, Animation · AE · C4D · Arnold',
  },
  ],
};
